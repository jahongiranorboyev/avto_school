    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(blank=True, null=True, upload_to='questions/%Y/%m/%d', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['mp4'])])),
                ('image', models.ImageField(blank=True, null=True, upload_to='questions/%Y/%m/%d', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png'])])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('last_quiz_results_avg', models.FloatField(blank=True, editable=False, null=True)),
            ],
        ),
    ]
