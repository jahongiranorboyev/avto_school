...
# from apps.general.serializers import LevelSerializer
# from apps.users.register import register_social_user
...
class GoogleSocialAuthSerializer(serializers.Serializer):
    ...
    def validate_auth_token(self, id_token):
        ...
        # email = user_id['email']
        # name = user_id['name']
        # user_code = user_id['user_code']
        # provider = 'google'

        # return register_social_user(provider=provider, user_id=user_id, email=email, full_name=name, user_code=user_code)
        return
